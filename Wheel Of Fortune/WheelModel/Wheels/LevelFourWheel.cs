...
namespace Wheel_Of_Fortune.WheelModel.Wheels {
    class LevelFourWheel : Wheel {
        public override void Initialize() {
            ...
            colorSetText = new ColorSet(Colors.Black, Colors.White);
            colorSetBack = new ColorSet(Colors.LightGray, Colors.DarkGray);
            third.Text = "$6000";
            third.Value = 6000;
            ...
            colorSetText.BottomColor = Colors.SaddleBrown;
            colorSetBack.TopColor = Colors.DarkGoldenrod;
            colorSetBack.BottomColor = Colors.Gold;
            third.Text = "$10,000";
            third.Value = 10000;
            third.Type = ThirdType.TenThousand;
            third.SetColor(colorSetText.DeepCopy(), colorSetBack.DeepCopy());
            list.Add(third.DeepCopy());
            third.Text = "BANKRUPT";
            third.Value = 0;
